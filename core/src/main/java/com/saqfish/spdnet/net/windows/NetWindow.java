...
//adlda
    ...
    public static void showKeyInput(){
        Game.runOnRenderThread(() -> ShatteredPixelDungeon.scene().add(new WndTextInput(Messages.get(NetWindow.class,
                "title")
                , Settings.auth_key(), 30,
                false, Messages.get(NetWindow.class,
                "Set"), Messages.get(NetWindow.class,
                "Cancel")){
            @Override
